...
#
#   docker build -t google-finance-scraper .
#   docker run --rm -v "$PWD/out:/out" google-finance-scraper \
#     --mode markets --market US --out /out/markets
#   docker run --rm -v "$PWD/out:/out" google-finance-scraper \
#     --mode quote --symbols GOOGL:NASDAQ,EUR-USD --out /out/quotes
#
